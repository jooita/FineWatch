...
func (this *CharsForMap) InsertCharsForMap() {
	...
	for i := range mapids { //order : offense:good,bad,normal / defense:good,bad,normal
		...
		case i < 3: //Assault
			// OFFENSE - GOOD
			cfm = CharsForMap{Maplist: &MapList{Id: listid}, Charid: &Character{Charid: "pharah"}, Explain: ""}
			ErrHandle(o.Insert(&cfm))
			cfm = CharsForMap{Maplist: &MapList{Id: listid}, Charid: &Character{Charid: "genji"}, Explain: ""}
			ErrHandle(o.Insert(&cfm))
			cfm = CharsForMap{Maplist: &MapList{Id: listid}, Charid: &Character{Charid: "reaper"}, Explain: ""}
			ErrHandle(o.Insert(&cfm))
			// OFFENSE - BAD
			listid++ //2,8,14
			...
			// DEFENSE - GOOD
			listid++ //4,10,16
			cfm = CharsForMap{Maplist: &MapList{Id: listid}, Charid: &Character{Charid: "bastion"}, Explain: ""}
			ErrHandle(o.Insert(&cfm))
			cfm = CharsForMap{Maplist: &MapList{Id: listid}, Charid: &Character{Charid: "torbjorn"}, Explain: ""}
			ErrHandle(o.Insert(&cfm))
			cfm = CharsForMap{Maplist: &MapList{Id: listid}, Charid: &Character{Charid: "mei"}, Explain: ""}
			ErrHandle(o.Insert(&cfm))
			cfm = CharsForMap{Maplist: &MapList{Id: listid}, Charid: &Character{Charid: "reinhardt"}, Explain: ""}
			ErrHandle(o.Insert(&cfm))
			...
			if mapids[i] == "anubis" {
				cfm = CharsForMap{Maplist: &MapList{Id: 1}, Charid: &Character{Charid: "ana"}, Explain: ""}
				ErrHandle(o.Insert(&cfm))
			}
